...
const Blogs = () => {
    return (
        <div className='bg-gray-200 p-40 mt-3'>
            ...
            <h1 className='text-3xl font-serif font-bold'><span className='text-red-600'>Ques:</span>What's the differcence between inline block and block elements?</h1>
